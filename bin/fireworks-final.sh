...
clear
center_colorstr $((rows / 6 - 1)) red "THANK YOU !"
center_colorstr $((rows / 6)) red "I Love you so!"
center_colorstr $((rows / 6 + 1)) red "I promise I always will."
center_colorstr $((rows / 6 + 2)) red "You left a mark on my heart..."
echo
